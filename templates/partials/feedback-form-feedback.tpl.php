...
<div id="invitetoshare">
	<p><strong><?php _e( 'Get feedback on this draft before publishing', 'writing-helper' ); ?></strong></p>

	<p class="invitetext"><label for="invitelist"><?php _e( 'Enter email addresses of people you would like to get feedback from:', 'writing-helper' ) ?></label></p>
...
%6$s', 'writing-helper' ),
	...
	<input type="submit" id="add-request-custom" value="<?php echo esc_attr( __( 'Send Requests', 'writing-helper' ) ); ?>" class="button-secondary" /> &nbsp;<a class="cancel" href="#"><?php _e( 'Cancel', 'writing-helper' ); ?></a>
	</div>
...
<?php else: ?>
<p><strong><?php _e( 'This post has already been published, so you can not request any more feedback, but you can see the feedback that has been provided before that. ', 'writing-helper' ); ?></strong></p>
<?php endif; ?>

<div id="add-request-sent" class="add-request-message" style="display:none">
<h4><?php _e( "Requests sent.", 'writing-helper' ); ?></h4>
<p><?php _e( "When your friends read your draft and give feedback, you'll get an email and the feedback will appear below.", 'writing-helper' ); ?></p>
